...
export default function CreateHackathonPage() {
    ...
    criteria: [
      {
        dimension: "技术创新性",
        weight: 40,
        description: "技术方案的前沿性与创新程度",
      },
      {
        dimension: "商业价值",
        weight: 30,
        description: "商业化潜力与市场需求匹配度",
      },
  ...
  const loadHackathonData = async (id: string) => {
    try {
      ...
      setFormData({
        ...
        timeline: [],
        criteria: data.scoring_dimensions
          ? JSON.parse(data.scoring_dimensions)
          : [],
      ...
      const mockAIResponse: FormData = {
        ...
        timeline: [
          ...
          },
          {
            phase: "黑客松开始",
            time_offset: "Day 2",
            description: "正式进入 coding 环节",
          },
          {
            phase: "作品提交",
            time_offset: "Day 14",
            description: "截止提交作品和演示",
          },
          {
            phase: "评审",
            time_offset: "Day 15-20",
            description: "专家评审团打分",
          },
          {
            phase: "颁奖典礼",
  ...
  const addCriteria = () => {
    setFormData((prev) => ({
      ...
      criteria: [
        ...prev.criteria,
        { dimension: "", weight: 0, description: "" },
      ],
    }));
  };
            ...
            <section className="bg-[#0A0A0A] border border-zinc-800/50 rounded-[16px] p-6">
              ...
              <div className="mt-4 flex items-center justify-between text-xs">
                ...
                <span className="text-brand font-mono">
                  ¥{" "}
                  {formData.awards
                    .reduce((sum, a) => sum + a.prize_pool * a.quota, 0)
                    .toLocaleString()}
                </span>
              </div>
            </section>
