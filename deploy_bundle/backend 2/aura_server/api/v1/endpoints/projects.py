...
from aura_server.models.team_project import Project, ProjectCreate, ProjectRead, ProjectStatus, Team, ProjectReadWithTeam
from aura_server.models.judge import Judge
from aura_server.models.score import Score, ScoreCreate, ScoreRead
...
def read_my_projects(*, session: Session = Depends(get_session), current_user: User = Depends(get_current_user)):
    ...
    """
    from aura_server.models.team_project import TeamMember
