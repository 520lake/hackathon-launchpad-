...
export default function CreateHackathonStep2({
  ...
  // 检查是否可以继续
  const canProceed =
    isCriteriaValid && prizeTiers.length > 0 && organizerName.trim() !== "";
          ...
          {["基本信息", "详细信息", "日程安排", "预览发布"].map(
            (step, index) => (
              <div key={step} className="flex items-center">
                ...
                {index < 3 && <div className="w-8 h-px bg-white/[0.08] mx-2" />}
              </div>
            ),
          )}
        </div>
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600 mt-2">
                    支持上传 JPG、PNG 格式（最大 5MB），或使用 AI 生成
                  </p>
                </div>
              </div>
            </div>
