  ...
  return (
    ...
    >
      <div className="flex justify-between items-end mb-12">
        ...
        <button
          onClick={onViewAll}
          className="text-brand font-mono text-sm hover:underline underline-offset-4"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {hackathons.map((h) => (
          <div
            key={h.id}
            className="event-card card-brutal group relative overflow-hidden cursor-pointer"
          ...
          >
            ...
            <div className="p-6 relative">
              ...
              <h3 className="text-xl font-bold text-ink mb-2 group-hover:text-brand transition-colors line-clamp-1">
                {h.title}
              </h3>
              <p className="text-gray-500 text-sm mb-6 line-clamp-2 h-10">
                {h.description}
              </p>
              <div className="flex justify-between items-center divider-t pt-4">
                <span className="font-mono text-xs text-gray-600">
                  {new Date(h.start_date).toLocaleDateString()}
                </span>
                <button
                  onClick={() => onDetailClick(h.id)}
                  className="text-brand text-sm font-bold hover:translate-x-1 transition-transform"
                >
        ...
        <div className="md:col-span-5 relative">
          ...
          <div className="w-full aspect-square border border-brand/20 relative rotate-3">
            ...
            <div className="absolute inset-0 bg-brand/5 backdrop-blur-sm flex items-center justify-center">
              <span className="font-mono text-brand/40 text-9xl font-black">
                AI
              </span>
            </div>
          </div>
    ...
    <section className="py-24 max-w-[1200px] mx-auto w-full px-6">
      ...
      <div className="relative border-l border-brand/20 ml-6 md:ml-1/2 space-y-12">
        {[
          {
            date: "PHASE_01",
            title: lang === "zh" ? "开放注册" : "Registration",
            desc: lang === "zh" ? "全球开放访问" : "Open global access.",
          },
          {
            date: "PHASE_02",
            title: lang === "zh" ? "组队阶段" : "Team Formation",
            desc: lang === "zh" ? "AI 智能匹配" : "AI-assisted matching.",
          },
          {
            date: "PHASE_03",
            title: lang === "zh" ? "开发冲刺" : "Development",
            desc: lang === "zh" ? "48小时极限编程" : "48h coding sprint.",
          },
          {
            date: "PHASE_04",
            title: lang === "zh" ? "评审阶段" : "Evaluation",
            desc:
              lang === "zh" ? "系统自动化评分" : "System automated scoring.",
          },
        ].map((item, idx) => (
...
export function Footer({ lang }: { lang: "zh" | "en" }) {
  return (
    <footer className="bg-surface divider-t-accent py-20">
      <div className="max-w-[1200px] mx-auto w-full px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          <h4 className="font-mono text-brand text-sm mb-6">
            {lang === "zh" ? "链接" : "LINKS"}
          </h4>
      ...
      <div className="max-w-[1200px] mx-auto w-full px-6 mt-20 pt-8 divider-t flex justify-between items-center text-xs font-mono text-gray-600">
