...
// VirtualUser type previously used for a lighter member shape; the full
// MemberDetail interface now covers all usages.
      ...
      {[20, 40, 60, 80, 100].map((level) => (
        <polygon
          ...
          points={angles
            .map(
              (a) =>
                `${center + radius * (level / 100) * Math.cos(a)},${center + radius * (level / 100) * Math.sin(a)}`,
            )
            .join(" ")}
          fill="none"
...
const MOCK_DISCUSSIONS: Discussion[] = [
  {
    ...
    author: "全栈小王",
    avatar:
      "https://api.dicebear.com/7.x/avataaars/svg?seed=xiaoyu&backgroundColor=c0aede",
    replies: 45,
    views: 1203,
    tags: ["经验分享", "新手入门"],
    isVirtual: true,
  ...
  },
  {
    ...
    author: "AI探索者_李明",
    avatar:
      "https://api.dicebear.com/7.x/avataaars/svg?seed=liming&backgroundColor=b6e3f4",
    replies: 12,
    views: 356,
    tags: ["组队", "AI", "医疗"],
    isVirtual: true,
  ...
  },
  {
    ...
    author: "CTO老马",
    avatar:
      "https://api.dicebear.com/7.x/avataaars/svg?seed=machao&backgroundColor=d1d4f9",
    replies: 28,
    views: 892,
    tags: ["技术讨论", "LLM"],
    isVirtual: true,
  ...
  },
  {
    ...
    author: "链上陈",
    avatar:
      "https://api.dicebear.com/7.x/avataaars/svg?seed=haoran&backgroundColor=d1d4f9",
    replies: 33,
    views: 1024,
    tags: ["Web3", "经验分享"],
    isVirtual: true,
  ...
  },
  {
    ...
    author: "设计琪",
    avatar:
      "https://api.dicebear.com/7.x/avataaars/svg?seed=siqi&backgroundColor=ffdfbf",
    replies: 19,
    views: 567,
    tags: ["设计", "团队协作"],
    isVirtual: true,
  ...
  },
  {
    ...
    author: "创新少女",
    avatar:
      "https://api.dicebear.com/7.x/avataaars/svg?seed=xiaoxiao&backgroundColor=ffd5dc",
    replies: 56,
    views: 1589,
    tags: ["线下活动", "上海", "组队"],
    isVirtual: true,
...
const MOCK_MEMBERS: MemberDetail[] = [
  {
    ...
    extendedBio:
      "清华大学人工智能博士，曾在Google DeepMind实习。专注于大语言模型和计算机视觉的交叉研究。发表过5篇顶会论文，开源项目获得3k+ stars。热爱黑客松文化，享受在48小时内将想法变为现实的快感。",
    location: "北京",
    pastProjects: [
      {
        name: "SmartDiagnosis",
      ...
      },
      {
        ...
        tech: ["OpenCV", "Transformers", "FastAPI"],
        award: "🥈 亚军",
        year: "2023",
      },
    ],
  ...
  },
  {
    ...
    extendedBio:
      "前字节跳动高级工程师，参与过飞书早期开发。全栈技术栈，擅长快速原型开发。独立开发过3个SaaS产品，累计服务10万+用户。相信好的产品是技术和设计的完美结合。",
    location: "上海",
    pastProjects: [
      {
        name: "DevFlow",
  ...
  },
  {
    ...
    extendedBio:
      "阿里巴巴前高级体验设计师，5年互联网产品设计经验。擅长设计系统构建和交互动效设计。对创意编程和生成式设计有浓厚兴趣，正在学习Three.js和WebGL。相信好的设计能让复杂的技术变得平易近人。",
    location: "杭州",
    pastProjects: [
      {
        name: "EcoVisual",
  ...
  },
  {
    ...
    extendedBio:
      "区块链开发者，3年Web3开发经验。曾参与知名DeFi协议的核心开发，合约审计经验丰富。对零知识证明和Layer2扩容方案有深入研究。相信区块链技术将重塑金融和协作方式。",
    location: "新加坡",
    pastProjects: [
      {
        name: "DeFiDashboard",
        tech: ["Solidity", "React", "TheGraph"],
        award: "🥇 冠军",
        year: "2024",
      },
      {
  ...
  },
  {
    ...
    nickname: "数据女王",
    avatar:
      "https://api.dicebear.com/7.x/avataaars/svg?seed=liufang&backgroundColor=c0aede",
    ...
    extendedBio:
      "前腾讯数据科学家，5年数据分析经验。擅长构建端到端的数据 pipeline，从数据采集到可视化展示。热爱数据可视化，相信好的可视化能让复杂数据一目了然。",
    location: "深圳",
    pastProjects: [
      {
        name: "InsightFlow",
  ...
  },
  {
    ...
    nickname: "移动开发赵",
    avatar:
      "https://api.dicebear.com/7.x/avataaars/svg?seed=zhaoyang&backgroundColor=b6e3f4",
    ...
    extendedBio:
      "8年移动开发经验，前美团高级移动端工程师。精通iOS和Android原生开发，也擅长Flutter跨平台开发。对移动端性能优化和动画效果有深入研究。",
    location: "北京",
    pastProjects: [
      {
        name: "ARShop",
        tech: ["Swift", "ARKit", "CoreML"],
        award: "🥇 冠军",
        year: "2024",
      },
      {
  ...
  },
  {
    ...
    nickname: "游戏创客",
    avatar:
      "https://api.dicebear.com/7.x/avataaars/svg?seed=zhougame&backgroundColor=ffdfbf",
    ...
    extendedBio:
      "独立游戏开发者，Unity和Unreal双引擎开发者。在Steam上架过2款独立游戏，累计销量5万份。热爱游戏叙事和程序化生成技术，相信游戏是最有力的表达方式。",
    location: "成都",
    pastProjects: [
      {
        name: "CyberQuest",
      ...
      {
        name: "DreamScape",
        tech: ["Unreal", "Blueprints", "Niagara"],
        award: "最佳创意奖",
        year: "2023",
      },
    ],
  ...
  },
  {
    ...
    nickname: "安全卫士",
    avatar:
      "https://api.dicebear.com/7.x/avataaars/svg?seed=wusecurity&backgroundColor=d1d4f9",
    skills:
      "Penetration Testing, Rust, Blockchain Security, Smart Contract Audit",
    ...
    extendedBio:
      "网络安全专家，白帽黑客，Web3安全研究员。曾发现多个知名DeFi协议的漏洞，获得百万美元漏洞赏金。热爱CTF比赛，多次获得国际赛事奖项。",
    location: "上海",
    pastProjects: [
      {
        name: "SecureDAO",
        tech: ["Rust", "Move", "Foundry"],
        award: "最佳安全奖",
        year: "2024",
      },
      {
        name: "AuditBot",
        tech: ["Python", "Slither", "ML"],
        award: "🥈 亚军",
        year: "2023",
      },
    ],
  ...
  },
  {
    ...
    extendedBio:
      "计算机科学专业大二学生，虽然技术还在学习中，但充满创意和执行力。擅长产品构思和演讲展示。参加过5次黑客松，获得2次奖项。相信年轻人的创造力能改变世界。",
    location: "杭州",
    pastProjects: [
      {
        name: "EcoTrack",
        tech: ["Arduino", "Python", "Flask"],
        award: "🥉 季军",
        year: "2024",
      },
      {
  ...
  },
  {
    ...
    extendedBio:
      "15年技术管理经验，前阿里巴巴技术总监，连续创业者。主导过日活千万级产品的技术架构。擅长团队建设和技术战略规划。正在寻找下一个创业机会。",
    location: "北京",
    pastProjects: [
      {
        name: "CloudNative",
      ...
      {
        name: "ScaleUp",
        tech: ["Microservices", "Kafka", "Redis"],
        award: "最佳架构奖",
        year: "2023",
      },
    ],
  ...
  },
  {
    ...
    nickname: "UX写手",
    avatar:
      "https://api.dicebear.com/7.x/avataaars/svg?seed=linwriter&backgroundColor=ffdfbf",
    ...
    extendedBio:
      "UX写作者和内容策略师，5年互联网产品文案经验。擅长将复杂的技术概念转化为用户友好的语言。相信好的文案是用户体验的重要组成部分。",
    location: "上海",
    pastProjects: [
      {
        name: "VoiceFirst",
        tech: ["NLP", "Voice UI", "Content Design"],
        award: "最佳文案奖",
        year: "2024",
      },
      {
        name: "ClearChat",
        tech: ["Conversational UI", "UX Writing"],
        award: "🥉 季军",
        year: "2023",
      },
    ],
  ...
  },
  {
    ...
    nickname: "MLOps黄",
    avatar:
      "https://api.dicebear.com/7.x/avataaars/svg?seed=huangops&backgroundColor=c0aede",
    ...
    extendedBio:
      "MLOps工程师，专注于机器学习模型的工程化和部署。精通Kubernetes和云原生技术栈。帮助多个AI团队将模型从实验室部署到生产环境，服务千万级用户。",
    location: "深圳",
    pastProjects: [
      {
        name: "AIOps",
        tech: ["Kubeflow", "MLflow", "Prometheus"],
        award: "🥈 亚军",
        year: "2024",
      },
      {
        name: "ModelMesh",
        tech: ["KServe", "Istio", "GPU"],
        award: "最佳工程奖",
        year: "2023",
      },
    ],
  ...
  },
  {
    ...
    nickname: "生物信息徐博士",
    avatar:
      "https://api.dicebear.com/7.x/avataaars/svg?seed=bioinfo&backgroundColor=ffdfbf",
    ...
    extendedBio:
      "中科院生物信息学博士，专注于用AI加速科学发现。曾参与人类基因组计划后续项目，发表多篇Nature子刊论文。相信交叉学科的力量，正在探索AI在生物医药领域的应用。",
    location: "北京",
    pastProjects: [
      {
        name: "GeneAI",
        tech: ["PyTorch", "AlphaFold", "BioPython"],
        award: "🥇 冠军",
        year: "2024",
      },
      {
  ...
  },
  {
    ...
    nickname: "量化小钱",
    avatar:
      "https://api.dicebear.com/7.x/avataaars/svg?seed=fintech&backgroundColor=d1d4f9",
    ...
    extendedBio:
      "前高盛量化分析师，现Web3创业者。精通传统金融和区块链技术，对金融科技充满热情。相信技术能让金融服务更普惠、更高效。",
    location: "香港",
    pastProjects: [
      {
        name: "QuantDeFi",
        tech: ["Solidity", "Python", "Pandas"],
        award: "🥇 冠军",
        year: "2024",
      },
      {
        name: "RiskGuard",
        tech: ["TensorFlow", "Risk Models", "React"],
        award: "最佳金融奖",
        year: "2023",
      },
    ],
  ...
  },
  {
    ...
    nickname: "机器人罗工",
    avatar:
      "https://api.dicebear.com/7.x/avataaars/svg?seed=robotics&backgroundColor=b6e3f4",
    ...
    extendedBio:
      "机器人工程师，5年ROS开发经验。参与过多个服务机器人和工业机器人项目。精通计算机视觉和SLAM算法，对具身智能有浓厚兴趣。",
    location: "深圳",
    pastProjects: [
      {
        name: "AutoNav",
        tech: ["ROS2", "SLAM", "Depth Camera"],
        award: "🥈 亚军",
        year: "2024",
      },
      {
  ...
  },
  {
    ...
    nickname: "气候科技绿",
    avatar:
      "https://api.dicebear.com/7.x/avataaars/svg?seed=climate&backgroundColor=c0aede",
    ...
    extendedBio:
      "气候科技创业者，环境科学背景。致力于用技术解决气候变化问题，开发过多个碳足迹追踪和能源管理项目。相信科技能让地球更可持续。",
    location: "上海",
    pastProjects: [
      {
        name: "CarbonTrack",
        tech: ["IoT", "Blockchain", "React"],
        award: "🥇 冠军",
        year: "2024",
      },
      {
        name: "EcoSmart",
        tech: ["Python", "ML", "Sensor Networks"],
        award: "最佳环保奖",
        year: "2023",
      },
    ],
  ...
  },
  {
    ...
    nickname: "教育科技教老师",
    avatar:
      "https://api.dicebear.com/7.x/avataaars/svg?seed=edtech&backgroundColor=ffdfbf",
    ...
    extendedBio:
      "前新东方名师，10年教育行业经验，现教育科技创业者。专注于AI赋能教育，开发自适应学习系统。相信技术能让优质教育触手可及。",
    location: "北京",
    pastProjects: [
      {
        name: "AI Tutor",
      ...
      {
        name: "LearnPath",
        tech: ["Knowledge Graph", "Vue.js", "Django"],
        award: "最佳教育奖",
        year: "2023",
      },
    ],
  ...
  },
  {
    ...
    nickname: "数字医疗医博士",
    avatar:
      "https://api.dicebear.com/7.x/avataaars/svg?seed=healthcare&backgroundColor=d1d4f9",
    ...
    extendedBio:
      "医学博士，3年临床经验转行科技。现数字医疗产品经理，既懂医学也懂技术。致力于用技术改善医疗服务，让患者获得更好的诊疗体验。",
    location: "上海",
    pastProjects: [
      {
        name: "MediAI",
        tech: ["Computer Vision", "PyTorch", "React"],
        award: "🥈 亚军",
        year: "2024",
      },
      {
  ...
  },
  {
    ...
    nickname: "创意编程艺艺术家",
    avatar:
      "https://api.dicebear.com/7.x/avataaars/svg?seed=creative&backgroundColor=ffd5dc",
    ...
    extendedBio:
      "新媒体艺术家，创意编程教育者。作品在国际数字艺术节展出。相信代码是一种创作媒介，技术和美学的融合能创造独特的体验。",
    location: "杭州",
    pastProjects: [
      {
        name: "Generative Dreams",
        tech: ["p5.js", "WebGL", "MIDI"],
        award: "🥇 冠军",
        year: "2024",
      },
      {
        name: "Interactive Flow",
        tech: ["TouchDesigner", "Python", "Sensors"],
        award: "最佳艺术奖",
        year: "2023",
      },
    ],
  ...
  },
  {
    ...
    nickname: "社会创新社",
    avatar:
      "https://api.dicebear.com/7.x/avataaars/svg?seed=social&backgroundColor=c0aede",
    ...
    extendedBio:
      "社会企业家，用商业手段解决社会问题。关注教育公平、环境保护和社区发展。相信技术应该服务于社会福祉，而不仅仅是商业利益。",
    location: "成都",
    pastProjects: [
      {
        name: "ImpactMap",
        tech: ["React", "GIS", "Data Viz"],
        award: "🥉 季军",
        year: "2024",
      },
      {
  ...
  },
  {
    ...
    nickname: "XR开发者虚",
    avatar:
      "https://api.dicebear.com/7.x/avataaars/svg?seed=xrdev&backgroundColor=b6e3f4",
    ...
    extendedBio:
      "XR开发者，Vision Pro早期开发者。专注于空间计算和混合现实应用开发。相信空间计算将重新定义人机交互，正在探索下一代计算平台的可能性。",
    location: "上海",
    pastProjects: [
      {
        name: "Spatial Workspace",
        tech: ["VisionOS", "SwiftUI", "RealityKit"],
        award: "🥇 冠军",
        year: "2024",
      },
      {
        name: "AR Museum",
        tech: ["ARKit", "Unity", "3D Modeling"],
        award: "最佳XR奖",
        year: "2023",
      },
    ],
  ...
  },
  {
    ...
    nickname: "物联网物工",
    avatar:
      "https://api.dicebear.com/7.x/avataaars/svg?seed=iot&backgroundColor=c0aede",
    ...
    extendedBio:
      "IoT架构师，10年物联网开发经验。从传感器到云平台，全栈IoT技术专家。参与过多个大型智慧城市和工业4.0项目。",
    location: "深圳",
    pastProjects: [
      {
        name: "SmartFactory",
        tech: ["MQTT", "Kubernetes", "Go"],
        award: "🥈 亚军",
        year: "2024",
      },
      {
        name: "EdgeAI",
        tech: ["TensorFlow Lite", "ESP32", "C++"],
        award: "最佳IoT奖",
        year: "2023",
      },
    ],
  ...
  },
  {
    ...
    nickname: "NLP语言学家语博士",
    avatar:
      "https://api.dicebear.com/7.x/avataaars/svg?seed=nlp&backgroundColor=ffdfbf",
    ...
    extendedBio:
      "计算语言学博士，NLP技术专家。专注于语义理解和多语言处理。参与过多个大语言模型的训练和优化。相信语言是智能的核心，致力于让机器真正理解人类。",
    location: "北京",
    pastProjects: [
      {
        name: "Polyglot AI",
  ...
  },
  {
    ...
    nickname: "云原生云架构师",
    avatar:
      "https://api.dicebear.com/7.x/avataaars/svg?seed=cloud&backgroundColor=d1d4f9",
    ...
    extendedBio:
      "云原生架构师，CNCF项目贡献者。帮助企业构建云原生应用平台，实现数字化转型。精通Kubernetes生态和云原生最佳实践。",
    location: "杭州",
    pastProjects: [
      {
        name: "CloudMesh",
        tech: ["Istio", "K8s", "Prometheus"],
        award: "🥇 冠军",
        year: "2024",
      },
      {
  ...
  },
  {
    ...
    nickname: "增长黑客张经理",
    avatar:
      "https://api.dicebear.com/7.x/avataaars/svg?seed=growth&backgroundColor=c0aede",
    ...
    extendedBio:
      "增长产品经理，8年互联网产品经验。擅长数据驱动的增长策略，曾帮助多个产品实现用户10倍增长。相信好的产品需要技术和增长的完美结合。",
    location: "上海",
    pastProjects: [
      {
        name: "GrowthEngine",
  ...
  },
  {
    ...
    nickname: "开源贡献者李",
    avatar:
      "https://api.dicebear.com/7.x/avataaars/svg?seed=opensource&backgroundColor=b6e3f4",
    ...
    extendedBio:
      "开源布道者，多个知名开源项目的核心维护者。热衷于技术社区建设和开发者教育。相信开源不仅是一种开发模式，更是一种协作文化。",
    location: "北京",
    pastProjects: [
      {
        name: "OpenDevTools",
        tech: ["Rust", "CLI", "Documentation"],
        award: "🥇 冠军",
        year: "2024",
      },
      {
        name: "CommunityHub",
        tech: ["Next.js", "Prisma", "OpenAPI"],
        award: "最佳社区奖",
        year: "2023",
      },
    ],
  ...
  },
  {
    ...
    nickname: "音频工程师音老师",
    avatar:
      "https://api.dicebear.com/7.x/avataaars/svg?seed=audio&backgroundColor=ffdfbf",
    ...
    extendedBio:
      "音频算法工程师，同时也是独立音乐人。相信声音是连接技术与艺术的桥梁。专注于AI音乐生成和空间音频技术，在黑客松中创造独特的音频体验。",
    location: "上海",
    pastProjects: [
      {
        name: "AI Composer",
        tech: ["Python", "Magenta", "Web Audio"],
        award: "🥉 季军",
        year: "2024",
      },
      {
  ...
  },
  {
    ...
    nickname: "法律科技法律师",
    avatar:
      "https://api.dicebear.com/7.x/avataaars/svg?seed=legal&backgroundColor=d1d4f9",
    ...
    extendedBio:
      "律师转行的产品经理，深刻理解法律行业的数字化转型需求。致力于用技术让法律服务更高效、更普惠。在黑客松中寻找法律科技的创新机会。",
    location: "北京",
    pastProjects: [
      {
        name: "SmartContract Audit",
        tech: ["Solidity", "Python", "ML"],
        award: "🥈 亚军",
        year: "2024",
      },
      {
  ...
  },
  {
    ...
    nickname: "农业科技农户",
    avatar:
      "https://api.dicebear.com/7.x/avataaars/svg?seed=agritech&backgroundColor=c0aede",
    ...
    extendedBio:
      "农业科技创业者，出身农村，致力于用技术助力乡村振兴。相信科技能让农业更智能、更环保。在黑客松中寻找改善农民生活的创新方案。",
    location: "成都",
    pastProjects: [
      {
        name: "SmartFarm",
          ...
          <div className="flex items-start justify-between mb-6">
            <div>
              <div className="flex items-center gap-3 mb-2">
                ...
                <span
                  className={`px-3 py-1 text-xs rounded-full border flex items-center gap-1.5 ${statusConfig.color}`}
                >
              ...
              <p className="text-zinc-400">
                {member.community_title || member.full_name}
              </p>
              {member.location && (
                ...
                <div key={i} className="bg-zinc-800/50 rounded-xl p-4">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {project.tech.map((t, j) => (
                      <span
                        key={j}
                        className="px-2 py-0.5 bg-zinc-700 text-zinc-400 text-xs rounded"
                      >
                        {t}
                      </span>
                    ))}
...
function CommunityProfileModal({
  ...
  const [activeTab, setActiveTab] = useState<"basic" | "skills" | "projects">(
    "basic",
  );
  ...
  const handleAddProject = () => {
    setPastProjects([
      ...pastProjects,
      { name: "", tech: [], year: new Date().getFullYear().toString() },
    ]);
  };
...
export default function CommunityPage() {
  ...
  const [activeTab, setActiveTab] = useState<"members" | "discussions">(
    "members",
  );
  ...
  const [discussions, setDiscussions] =
    useState<Discussion[]>(MOCK_DISCUSSIONS);
  ...
  const [myProfile, setMyProfile] = useState<CommunityProfile>({
    ...
    extendedBio:
      "我是一名充满热情的全栈开发者，专注于构建用户友好的Web应用。参加过多次黑客松，享受在有限时间内创造有价值产品的挑战。",
    location: "北京",
    pastProjects: [
      {
        name: "MyFirstHack",
  ...
  const handleCreateDiscussion = (data: {
    ...
    const newDiscussion: Discussion = {
      ...
      author: "我",
      avatar:
        "https://api.dicebear.com/7.x/avataaars/svg?seed=me&backgroundColor=c0aede",
      replies: 0,
      views: 0,
      tags: data.tags,
      isVirtual: false,
                    ...
                    {members.map((member) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div
                            className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs border mb-3 ${statusConfig.color}`}
                          >
                            <StatusIcon className="w-3 h-3" />
                            {statusConfig.label}
                          </div>
