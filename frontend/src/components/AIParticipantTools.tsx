...
const AIParticipantTools: React.FC<AIParticipantToolsProps> = ({
  user,
  hackathon,
}) => {
  const [activeTool, setActiveTool] = useState<"idea" | "pitch" | "roadmap">(
    "idea",
  );
  ...
  return (
    <div
      ref={containerRef}
      className="h-full flex flex-col gap-6 text-[#D4A373]"
    >
      {/* Tool Selector */}
          ...
          <div className="space-y-6">
            <div className="bg-[#D4A373]/5 p-6 border border-[#D4A373]/20">
              ...
              <p className="text-sm opacity-70 mb-6 font-mono">
                ...
                {user.skills?.length ? user.skills.join(", ") : "General"}) and
                the hackathon theme ({hackathon.theme_tags || "General"}).
              </p>
            ...
            {ideas.length > 0 && (
              <div className="grid gap-4">
                {ideas.map((idea, idx) => (
                  <div
                    key={idx}
                    className="bg-[#1a1a1a] border border-[#D4A373]/30 p-5 hover:border-[#D4A373] transition-colors group"
                  >
                    ...
                    <div className="text-xs font-mono text-[#D4A373]/60">
                      <span className="text-[#D4A373]">STACK:</span>{" "}
                      {idea.tech_stack}
                    </div>
                  </div>
                ))}
        ...
        {activeTool === "pitch" && (
          <div className="space-y-6">
            <div className="bg-[#D4A373]/5 p-6 border border-[#D4A373]/20">
              ...
              <p className="text-sm opacity-70 mb-6 font-mono">
                Turn your project description into a structured presentation
                outline.
              </p>
            ...
            {slides.length > 0 && (
              <div className="space-y-4">
                {slides.map((slide, idx) => (
                  <div
                    key={idx}
                    className="bg-[#1a1a1a] border border-[#D4A373]/30 p-5 relative overflow-hidden"
                  >
                    ...
                    <div className="mb-4">
                      <div className="text-xs text-[#D4A373]/50 mb-1 font-mono uppercase">
                        Slide Content
                      </div>
              ...
              <div className="relative border-l-2 border-[#D4A373]/30 ml-4 space-y-8 py-4">
                {roadmap.map((step, idx) => (
                  <div key={idx} className="relative pl-8">
                    ...
                    <h4 className="text-[#D4A373] font-bold text-lg mb-1 font-mono">
                      STEP {idx + 1}
                    </h4>
