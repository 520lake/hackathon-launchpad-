...
/** Hero section with CTA buttons that navigate to /create and /explore pages (no popups). */
export default function Hero({ lang }: HeroProps) {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1200px] mx-auto w-full px-6 z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        {/* Left Column: Content */}
        <div className="lg:col-span-7 flex flex-col items-start text-left">
          ...
          <h1
            ref={textRef}
            className="text-6xl md:text-9xl font-black mb-6 leading-none tracking-tighter mix-blend-difference text-ink"
          >
            <span className="block text-glitch" data-text="AURA">
              AURA
            </span>
          ...
          <p
            ref={subTextRef}
            className="max-w-2xl text-xl md:text-2xl text-gray-400 font-light mb-12 leading-relaxed"
          >
            {lang === "zh" ? (
              <>
                在 <span className="text-brand font-mono">噪音</span>{" "}
                中寻找信号。
                <br />
                打造中国最大的开发者黑客松中心平台。
              </>
              ...
              <>
                ...
                <span className="text-brand font-mono">NOISE</span>.<br />
          ...
          <div ref={btnRef} className="flex flex-col sm:flex-row gap-6">
            <Link
              to="/create"
              className="group relative px-8 py-4 bg-brand text-void font-bold text-lg overflow-hidden transition-all hover:bg-white clip-path-slant inline-block text-center"
            >
            ...
            <Link
              to="/explore"
              className="group px-8 py-4 border border-white/20 text-ink font-mono text-lg hover:border-brand hover:text-brand transition-all text-center inline-block"
            >
