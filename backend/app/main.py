...
# 3. Frontend Static Files (Root) - [ModelScope Compatibility / Legacy]
# In standard Docker deployment, Nginx handles frontend serving. 
# This logic is kept for standalone backend testing or specific single-container deployments.
