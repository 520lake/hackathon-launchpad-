...
export default function Hero({ onCreateClick, onExploreClick, onCommunityClick }: HeroProps) {
    ...
    return (
        <section ref={containerRef} className="relative min-h-[90vh] lg:min-h-screen flex items-center overflow-hidden bg-void pt-24 lg:pt-20">
          ...
          <h1 ref={textRef} className="text-4xl sm:text-5xl lg:text-7xl font-black mb-4 lg:mb-6 tracking-tighter text-ink italic leading-tight">
             AI <span className="text-brand">EMPOWERED</span> HACKATHONS
          </h1>

          <p ref={subTextRef} className="max-w-2xl text-sm sm:text-base lg:text-lg text-ink-dim font-mono mb-6 lg:mb-8 leading-relaxed">
          ...
          {/* Role Cards */}
          <div ref={cardsRef} className="grid grid-cols-2 gap-3 sm:gap-4 w-full max-w-2xl">
               {/* Organizer */}
               <div className="group p-3 sm:p-4 border border-brand/20 bg-surface/60 backdrop-blur-sm hover:bg-brand hover:text-void transition-all duration-300 relative overflow-hidden rounded-sm">
                   <div className="absolute top-0 right-0 p-2 opacity-10 text-xl sm:text-3xl group-hover:opacity-20 transition-opacity">🏗️</div>
               ...
               {/* Participant */}
               <div className="group p-3 sm:p-4 border border-brand/20 bg-surface/60 backdrop-blur-sm hover:bg-brand hover:text-void transition-all duration-300 relative overflow-hidden rounded-sm">
                   <div className="absolute top-0 right-0 p-2 opacity-10 text-xl sm:text-3xl group-hover:opacity-20 transition-opacity">🚀</div>
                   <h3 className="font-bold font-mono text-xs sm:text-sm mb-1 text-brand group-hover:text-void uppercase">
                       参与者
                   </h3>
                   <p className="text-[10px] text-ink-dim group-hover:text-void/70 font-mono leading-tight">
