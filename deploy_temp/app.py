...
# 关键：将当前目录添加到系统路径，确保能够导入 app. 模块
current_dir = os.path.dirname(os.path.abspath(__file__))
if current_dir not in sys.path:
    sys.path.append(current_dir)
# Ensure backend package is importable: /app/backend contains the 'app' package
...
async def startup_event():
    logger.info("--- AURA API STARTUP: VERSION 2026-02-10-MODEL-SCOPE-DEPLOY-v1.6-AUTO-DB-INIT ---")
    # 确保数据库表已创建
    init_db()
